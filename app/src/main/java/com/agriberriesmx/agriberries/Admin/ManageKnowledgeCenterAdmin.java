...
public class ManageKnowledgeCenterAdmin extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_manage_knowledge_center);
        Firestore.deleteDocuments("knowledge", "deleted");
        setup();
    }
    ...
    protected void onResume() {
        ...
        SpinnerCropAdapter spinnerCropAdapter = new SpinnerCropAdapter(ManageKnowledgeCenterAdmin.this, cropNameList);
    ...
    private void setup() {
        ...
        knowledgeAdapter = new KnowledgeAdapter(filteredKnowledgeList, true);
        ...
        btnCreateKnowledge.setOnClickListener(v -> startActivity(new Intent(this, CreateKnowledgeAdmin.class)));
    }
    ...
    private void getKnowledge() {
        ...
        knowledgeListener = collectionReference.orderBy("deleted", Query.Direction.DESCENDING)
                .orderBy("title")
