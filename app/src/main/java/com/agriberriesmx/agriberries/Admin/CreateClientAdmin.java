...
public class CreateClientAdmin extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_create_client);
        setup();
    }
    ...
    private void setup() {
        ...
        tvRegistration.setOnClickListener(v -> {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(CreateClientAdmin.this, (view, updatedYear, updatedMonth, updatedDay) -> {
                // Update birth date
    ...
    private void createClient() {
        ...
        if (ccp.isValidFullNumber()) {
            if (!name.isEmpty() && !manager.isEmpty() && !business.isEmpty()) {
                ...
                client.setConsultants(new ArrayList<>());
                ...
                Toast.makeText(CreateClientAdmin.this, getResources().getString(R.string.clientCreated), Toast.LENGTH_SHORT).show();
                finish();
