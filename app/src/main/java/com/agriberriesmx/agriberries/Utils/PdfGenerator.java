...
public class PdfGenerator {
    ...
    public static void generatePdf(Context context, Diagnostic diagnostic, Unit unit, List<Block> blocks, List<Item> items, List<Nutrient> nutrients, String dest) throws Exception {
        ...
        Table tableGeneralInfo =  new Table(UnitValue.createPercentArray(new float[]{1})).useAllAvailableWidth();

        // Create general information table header
        String generalInformationHeader = context.getResources().getString(R.string.pdf_header_general_information);
        ...
        Table secondTableInfo = new Table(UnitValue.createPercentArray(new float[]{0.100f, 0.150f, 0.100f, 0.150f, 0.100f, 0.150f, 0.100f, 0.150f})).useAllAvailableWidth();

        for (int counter = 0; counter < secondTitles.length; counter++) {
            Paragraph info = new Paragraph(secondTitles[counter]);
            if (counter % 2 == 0) info.setBold();
        ...
        String[] thirdTitles = {
                context.getResources().getString(R.string.pdf_system), unit.getManagement() + "-" + unit.getSoil(),
                context.getResources().getString(R.string.pdf_altitude), String.valueOf(unit.getAltitude()),
                context.getResources().getString(R.string.pdf_hectares), String.valueOf(unit.getHectares()),
                context.getResources().getString(R.string.pdf_week), weekOfYear + "." + String.valueOf(year).substring(2)
        };
        Table thirdTableInfo = new Table(UnitValue.createPercentArray(new float[]{0.100f, 0.150f, 0.100f, 0.150f, 0.100f, 0.150f, 0.100f, 0.150f})).useAllAvailableWidth();
        ...
        Table phenologyTable =  new Table(UnitValue.createPercentArray(new float[]{1})).useAllAvailableWidth();
        ...
        Table secondPhenologyTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.20f, 0.18f, 0.50f})).useAllAvailableWidth();
        ...
        Table thirdPhenologyTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.20f, 0.18f, 0.50f})).useAllAvailableWidth();
        ...
        for (Block block : blocks) {
            ...
            // Create simple date format
            SimpleDateFormat formatter = new SimpleDateFormat("d 'de' MMMM 'de' yyyy", new Locale("es", "MX"));
        ...
        Table secondPlagueTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.63f, 0.25f})).useAllAvailableWidth();
        ...
        Table thirdPlagueTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.63f, 0.25f})).useAllAvailableWidth();
        ...
        Table deficiencyTable =  new Table(UnitValue.createPercentArray(new float[]{1})).useAllAvailableWidth();
        ...
        Table secondDeficiencyTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.63f, 0.25f})).useAllAvailableWidth();
        ...
        Table thirdDeficiencyTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.63f, 0.25f})).useAllAvailableWidth();
        ...
        Table contingencyTable =  new Table(UnitValue.createPercentArray(new float[]{1})).useAllAvailableWidth();
        ...
        Table secondContingencyTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.63f, 0.25f})).useAllAvailableWidth();
        ...
        Table thirdContingencyTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.63f, 0.25f})).useAllAvailableWidth();
        ...
        Table secondActivityTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.63f, 0.25f})).useAllAvailableWidth();
        ...
        Table thirdActivityTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.63f, 0.25f})).useAllAvailableWidth();
        ...
        for (Item item : items) {
            if (!item.getPhenology().equals(context.getResources().getString(R.string.done))) {
                ...
                for (String activity : activities) {
                    ...
                    Table progressBar = new Table(UnitValue.createPercentArray(new float[]{percentage, 100 - percentage}));
                    progressBar.useAllAvailableWidth();

                    // Progress cell
                    Cell progressCell = new Cell()
                            .add(new Paragraph(""))
                            .setBackgroundColor(Formatting.getColorForPercentage(percentage))
                            .setHeight(10)
                            .setPadding(0);
        ...
        Table secondTaskTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.63f, 0.25f})).useAllAvailableWidth();
        ...
        Table thirdTaskTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.63f, 0.25f})).useAllAvailableWidth();
        ...
        Table secondHarvestTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.18f, 0.17f, 0.18f, 0.17f, 0.18f})).useAllAvailableWidth();
        ...
        // Create third task table
        Table thirdHarvestTable = new Table(UnitValue.createPercentArray(new float[]{0.12f, 0.18f, 0.17f, 0.18f, 0.17f, 0.18f})).useAllAvailableWidth();
        ...
        for (Item item : items) {
            if (item.getPhenology().contains(context.getResources().getString(R.string.harvest_text))) {
                // Change state
                if (!isHarvestInfo) isHarvestInfo = true;
                ...
                Cell sizeCell = new Cell(1, 1)
                        .add(new Paragraph(item.getFruitSize() != null ? item.getFruitSize() : "NA"))
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE);
                ...
                if (unit.getCrop().equals(context.getResources().getString(R.string.blackberry)) ||
                        unit.getCrop().equals(context.getResources().getString(R.string.raspberry))) {
                    ratio = (100 / block.getFurrowDistance()) * 100 * 2;
                } else ratio = 10000 / (block.getFurrowDistance() * block.getPlantDistance());
                ratio = Math.round(ratio);

                // Calculate kilogram per hectare
                double kilogramPerHectare = (ratio * item.getFruitPerPlantMeter() * item.getGramPerFruit()) / 1000;
                kilogramPerHectare = kilogramPerHectare * (1 - (double) (item.getShrinkagePercentage()) / 100);

                // Add kilogram per hectare
                Cell kilogramPerPlantCell = new Cell(1, 1)
                        .add(new Paragraph(String.format(Locale.getDefault(), "%,d", (int) Math.round(kilogramPerHectare))))
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE);
        ...
        Table nutrientsDropperTable =  new Table(UnitValue.createPercentArray(new float[]{1})).useAllAvailableWidth();
        ...
        Table secondNutrientsDropperTable = new Table(UnitValue.createPercentArray(new float[]{0.15f, 0.14f, 0.14f, 0.14f, 0.14f, 0.14f, 0.15f})).useAllAvailableWidth();
        ...
        Table thirdNutrientsDropperTable = new Table(UnitValue.createPercentArray(new float[]{0.15f, 0.14f, 0.14f, 0.14f, 0.14f, 0.14f, 0.15f})).useAllAvailableWidth();
        ...
        for (Nutrient nutrient :  nutrientList) {
            if (isNutrientsDropperEmpty) {
                if (nutrient.getNitrate().get(0) != 0) isNutrientsDropperEmpty = false;
                if (nutrient.getCalcium().get(0) != 0) isNutrientsDropperEmpty = false;
                if (nutrient.getSodium().get(0) != 0) isNutrientsDropperEmpty = false;
                if (nutrient.getPotassium().get(0) != 0) isNutrientsDropperEmpty = false;
                if (nutrient.getPh().get(0) != 0.0) isNutrientsDropperEmpty = false;
                if (nutrient.getConductivity().get(0) != 0.0) isNutrientsDropperEmpty = false;
            } else break;
        }
        ...
        if (!isNutrientsDropperEmpty) {
            ...
            for (Nutrient nutrient : nutrientList) {
                ...
                Cell nitrateCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getNitrate().get(0), 0));
                ...
                Cell calciumCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getCalcium().get(0), 0));
                ...
                Cell sodiumCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getSodium().get(0), 1));
                ...
                Cell potassiumCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getPotassium().get(0), 0));
                ...
                Cell phCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getPh().get(0), 2));
        ...
        Table nutrientsDrainageTable =  new Table(UnitValue.createPercentArray(new float[]{1})).useAllAvailableWidth();

        // Create nutrients (drainage) table header
        String nutrientsDrainageHeader = context.getResources().getString(R.string.pdf_header_nutrients_drainage);
        ...
        Table secondNutrientsDrainageTable = new Table(UnitValue.createPercentArray(new float[]{0.15f, 0.14f, 0.14f, 0.14f, 0.14f, 0.14f, 0.15f})).useAllAvailableWidth();
        ...
        Table thirdNutrientsDrainageTable = new Table(UnitValue.createPercentArray(new float[]{0.15f, 0.14f, 0.14f, 0.14f, 0.14f, 0.14f, 0.15f})).useAllAvailableWidth();

        // Get boolean to know if nutrients drainage is empty
        boolean isNutrientsDrainageEmpty = true;
        for (Nutrient nutrient :  nutrientList) {
            if (isNutrientsDrainageEmpty) {
                if (nutrient.getNitrate().get(1) != 0) isNutrientsDrainageEmpty = false;
                if (nutrient.getCalcium().get(1) != 0) isNutrientsDrainageEmpty = false;
                if (nutrient.getSodium().get(1) != 0) isNutrientsDrainageEmpty = false;
                if (nutrient.getPotassium().get(1) != 0) isNutrientsDrainageEmpty = false;
                if (nutrient.getPh().get(1) != 0.0) isNutrientsDrainageEmpty = false;
                if (nutrient.getConductivity().get(1) != 0.0) isNutrientsDrainageEmpty = false;
            } else break;
        }
        ...
        if (!isNutrientsDrainageEmpty) {
            ...
            for (Nutrient nutrient : nutrientList) {
                ...
                Cell nitrateCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getNitrate().get(1), 0));
                ...
                Cell calciumCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getCalcium().get(1), 0));
                ...
                Cell sodiumCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getSodium().get(1), 1));
                ...
                Cell potassiumCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getPotassium().get(1), 0));
                ...
                Cell phCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getPh().get(1), 2));
        ...
        Table nutrientsSubstratumTable =  new Table(UnitValue.createPercentArray(new float[]{1})).useAllAvailableWidth();

        // Create nutrients (substratum) table header
        String nutrientsSubstratumHeader = context.getResources().getString(R.string.pdf_header_nutrients_substratum);
        ...
        Table secondNutrientsSubstratumTable = new Table(UnitValue.createPercentArray(new float[]{0.15f, 0.14f, 0.14f, 0.14f, 0.14f, 0.14f, 0.15f})).useAllAvailableWidth();

        // Create second nutrients substratum table header
        String[] secondNutrientsSubstratumTableHeader = {context.getResources().getString(R.string.headerBlock),
                context.getResources().getString(R.string.headerNitrateSymbol),
                context.getResources().getString(R.string.headerCalciumSymbol),
                context.getResources().getString(R.string.headerSodiumSymbol),
                context.getResources().getString(R.string.headerPotassiumSymbol),
        ...
        Table thirdNutrientsSubstratumTable = new Table(UnitValue.createPercentArray(new float[]{0.15f, 0.14f, 0.14f, 0.14f, 0.14f, 0.14f, 0.15f})).useAllAvailableWidth();

        // Get boolean to know if nutrients substratum is empty
        boolean isNutrientsSubstratumEmpty = true;
        for (Nutrient nutrient :  nutrientList) {
            if (isNutrientsSubstratumEmpty) {
                if (nutrient.getNitrate().get(2) != 0) isNutrientsSubstratumEmpty = false;
                if (nutrient.getCalcium().get(2) != 0) isNutrientsSubstratumEmpty = false;
                if (nutrient.getSodium().get(2) != 0) isNutrientsSubstratumEmpty = false;
                if (nutrient.getPotassium().get(2) != 0) isNutrientsSubstratumEmpty = false;
                if (nutrient.getPh().get(2) != 0.0) isNutrientsSubstratumEmpty = false;
                if (nutrient.getConductivity().get(2) != 0.0) isNutrientsSubstratumEmpty = false;
            } else break;
        }
        ...
        if (!isNutrientsSubstratumEmpty) {
            ...
            for (Nutrient nutrient : nutrientList) {
                ...
                Cell nitrateCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getNitrate().get(2), 0));
                ...
                Cell calciumCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getCalcium().get(2), 0));
                ...
                Cell sodiumCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getSodium().get(2), 1));
                ...
                Cell potassiumCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getPotassium().get(2), 0));
                ...
                Cell phCell = new Cell()
                        ...
                        .setTextAlignment(TextAlignment.CENTER)
                        .setVerticalAlignment(VerticalAlignment.MIDDLE)
                        .setBackgroundColor(Formatting.getColorForNutrient(context, unit.getCrop(), nutrient.getPh().get(2), 2));
        ...
        Table nutrientsFoliageTable =  new Table(UnitValue.createPercentArray(new float[]{1})).useAllAvailableWidth();
        ...
        Table secondNutrientsFoliageTable = new Table(UnitValue.createPercentArray(new float[]{0.15f, 0.14f, 0.14f, 0.14f, 0.14f, 0.14f, 0.15f})).useAllAvailableWidth();
        ...
        Table thirdNutrientsFoliageTable = new Table(UnitValue.createPercentArray(new float[]{0.15f, 0.14f, 0.14f, 0.14f, 0.14f, 0.14f, 0.15f})).useAllAvailableWidth();

        // Get boolean to know if nutrients foliage is empty
        boolean isNutrientsFoliageEmpty = true;
        for (Nutrient nutrient :  nutrientList) {
            if (isNutrientsFoliageEmpty) {
                if (nutrient.getNitrate().get(3) != 0) isNutrientsFoliageEmpty = false;
                if (nutrient.getCalcium().get(3) != 0) isNutrientsFoliageEmpty = false;
                if (nutrient.getSodium().get(3) != 0) isNutrientsFoliageEmpty = false;
                if (nutrient.getPotassium().get(3) != 0) isNutrientsFoliageEmpty = false;
                if (nutrient.getPh().get(3) != 0.0) isNutrientsFoliageEmpty = false;
                if (nutrient.getConductivity().get(3) != 0.0) isNutrientsFoliageEmpty = false;
            } else break;
        }
        ...
        Table emptyNutrientsTable =  new Table(UnitValue.createPercentArray(new float[]{1})).useAllAvailableWidth();
        ...
        Table observationsTable =  new Table(UnitValue.createPercentArray(new float[]{1})).useAllAvailableWidth();
        ...
        Table secondObservationsTable =  new Table(UnitValue.createPercentArray(new float[]{1})).useAllAvailableWidth();

        // Create second observations table header
        String observations = diagnostic.getObservations();
        if (observations.isEmpty()) observations = context.getResources().getString(R.string.no_observations);
        ...
        Table secondScoreTable = new Table(UnitValue.createPercentArray(new float[]{0.20f, 0.20f, 0.20f, 0.20f, 0.20f})).useAllAvailableWidth();
        ...
        Table thirdScoreTable = new Table(UnitValue.createPercentArray(new float[]{0.20f, 0.20f, 0.20f, 0.20f, 0.20f})).useAllAvailableWidth();
        ...
        Table executionTable =  new Table(UnitValue.createPercentArray(new float[]{1})).useAllAvailableWidth();
        ...
        Table secondExecutionTable = new Table(UnitValue.createPercentArray(new float[]{0.25f, 0.25f, 0.50f})).useAllAvailableWidth();
        ...
        String[] secondExecutionTableHeader = {context.getResources().getString(R.string.header_applications),
                context.getResources().getString(R.string.header_fertilizers), context.getResources().getString(R.string.header_tendency)};
        ...
        Table thirdExecutionTable = new Table(UnitValue.createPercentArray(new float[]{0.25f, 0.25f, 0.50f})).useAllAvailableWidth();
        ...
        } else document.add(emptyNutrientsTable);
        ...
        if (average >= 8) faceDrawable = ContextCompat.getDrawable(context, R.drawable.ic_happy_face);
        else if (average >= 6) faceDrawable = ContextCompat.getDrawable(context, R.drawable.ic_serious_face);
        else faceDrawable = ContextCompat.getDrawable(context, R.drawable.ic_sad_face);
    ...
    private static Bitmap createBarChartBitmap(Context context, List<Block> blocks, List<Item> items, boolean avocado) {
        ...
        canvas.drawText(context.getResources().getString(R.string.pdf_header_heights), textX - (maxBarHeight / 2f), textY + 20, paint);
        canvas.restore();
