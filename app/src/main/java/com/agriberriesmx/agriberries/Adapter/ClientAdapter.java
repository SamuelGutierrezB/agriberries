...
public class ClientAdapter extends RecyclerView.Adapter<ClientAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setup(Client client) {
            ...
            if (client.isBlocked()) tvName.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_red_circle, 0, 0, 0);
        ...
        private void changeActivity(Context context, Client client) {
            ...
            Intent intent;
            if (admin) intent = new Intent(context, ShowClientAdmin.class).putExtra("id", client.getId());
            else intent = new Intent(context, ShowClientActivity.class).putExtra("client", client);
